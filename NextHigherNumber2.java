...
public class NextHigherNumber2 
{

	public static void calculateNextHigherNumber(Integer num)
	{
		Integer temp = num;
	...
	{
		calculateNextHigherNumber(32841);
		calculateNextHigherNumber(12543);
		calculateNextHigherNumber(4132);
		calculateNextHigherNumber(1234);
	}
